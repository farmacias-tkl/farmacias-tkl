...
ahora **RESUELTA** — y "2C-C" — ahora **RESUELTA EN PRODUCCIÓN**.)*

**Actualización 2C-C (2026-06-29).** La política de `UserPermission` sobre usuarios inactivos
está **RESUELTA en producción** (merge `ffe43b5` + Vercel Production Ready + verificación
funcional post-deploy contra servicio real + Neon prod OK; cero escrituras; tests 101/50,
tsc OK). **2F queda habilitada como próximo paso, pero aún NO iniciada** (tiene su propio gate).
