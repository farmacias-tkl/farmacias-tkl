...
export default function Page() {
  return (
    <div className="card p-10 text-center">
      ...
      <h2 className="text-base font-semibold text-gray-700 mb-2">Tareas</h2>
      <p className="text-sm text-gray-400 max-w-sm mx-auto">Tareas de supervisión por sucursal.</p>
